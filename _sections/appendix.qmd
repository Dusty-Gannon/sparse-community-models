...
For regression coefficients that get spike-slab priors, we assume that 
...
where $\mathbb{E}[\delta_k]$ is the current expectation of the indicator variable $\delta_k$. 
